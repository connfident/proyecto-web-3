          ...
          <table class="table table-striped table-secondary">
              <thead>
                  <tr>
                    ...
                    @if(Auth::user()->perfil_id == 1)<th scope="col">Tipo</th>@endif
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    @if(Auth::user()->perfil_id == 1)<td>@if($cuenta->perfil_id == 1) Administrador @endif @if($cuenta->perfil_id == 2) Artista @endif</td>@endif
                    <td>
